...
const POSITIVE_RULES: TagRule[] = [
  ...
  // 상황 / 감정 / 특수 조건
  { tag: "hangover", keywords: ["해장", "숙취", "과음", "술", "속풀이", "속쓰려", "속쓰림", "어제술"] },
  { tag: "diet", keywords: ["다이어트", "살", "체중", "칼로리", "식단", "단백질"] },
  { tag: "mara", keywords: ["마라", "마라탕", "마라샹궈", "얼얼"] },

  // 상황 / 가격
  { tag: "cheap", keywords: ["가성비", "저렴", "싸게", "알뜰", "부담없는가격", "학생"] },
  { tag: "premium", keywords: ["특별", "고급", "비싼", "맛있는거", "기분내", "플렉스", "오마카세", "사치"] },
